...
class Traveler(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-localexperts.travelers', '-advertisers.travelers', '-posts.travelers')
...
class LocalExpert(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-travelers.localexperts', '-advertisers.localexperts', '-posts.localexperts')
...
class Advertiser(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-travelers.advertisers', '-localexperts.advertisers', '-posts.advertisers')
...
class Post(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-travelers.posts', '-localexperts.posts', '-advertisers.posts')